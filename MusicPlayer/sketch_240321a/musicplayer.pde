...
PImage chocolatecakeBackground;
...
void setup() {
  ...
  //Variable Population
  //Images
  String chocolatecakeImage = "chocolatecake Background Image";
  String darthvader = "Mini Cakes";
  String chocolatecake = "chocolatecake";
  String extensionJPG = ".jpg";
  String pathway = "../../Images/";
  String landscape_Square = "Landscape & Square Images/";
  String portrait = "Portrait/";
  String backgroundFileName = "Background images/";
  pathLightBackgroundImage = pathway + backgroundFileName + chocolatecakeImage + extensionJPG;
  pathDarkBackgroundImage = pathway + portrait + darthvader + extensionJPG;
  String albumCoverImagePath = pathway + landscape_Square + coolest-pictures-gl92yj777t58pibj + extensionWEBP;
